...
# The coverage sampler itself only requires torch; torchvision is not part of
# this cached-feature experiment and must not suppress its unit tests.
if importlib.util.find_spec("torch") is None:
    pytest.skip("nucleus coverage tests require torch", allow_module_level=True)
